...
parser.add_argument("--l", default=100, type=int, help="lambda value for generator loss")
parser.add_argument("--batch_size", default=10, type=int)
parser.add_argument("--threshold", default=0.5, type=float, help="confidence threshold for thresh_S, note output")
...
saver = tf.train.Saver(tf.get_collection(tf.GraphKeys.GLOBAL_VARIABLES, "gen"))
sess = tf.Session()
