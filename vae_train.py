...
parser.add_argument("--checkpoint_dir", default="modelv", type=str)

parser.add_argument("--epochs", default=20000, type=int, help="The number of training epochs that we are going to run. For each epoch we go through the entire data set.")
parser.add_argument("--batch_size", default=100, type=int, help="The number of training examples that we are going to send through the model at a time. ")
parser.add_argument("--threshold", default=0.67, type=float, help="confidence threshold for thresh_S, note output")
...
num_epochs = 10000  # The number of training epochs that we are going to run. For each epoch we go through the entire data set.
